...
class Order(models.Model):
    ...
    total_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0)  # total price for all products
...
class ProductInOrder(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.amount_per_item = price_per_item

        self.total_amount = price_per_item * self.count
        ...
        self.order.total_amount = order.total_amount
